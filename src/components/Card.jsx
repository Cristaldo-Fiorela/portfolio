...
const Card = ({ 
  ...
  return (
    <article className={`bg-neutral-800/70 p-4 rounded-2xl border-2 w-full ${borderColor} flex flex-col gap-3 justify-between`}>
      ...
      <a href="#" target="_blank" rel="noopener noreferrer" className="flex gap-1 items-center text-yellow">
