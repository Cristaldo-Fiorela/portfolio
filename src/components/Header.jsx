...
const Header = () => {
  ...
  return (
    <header className="bg-neutral-800 text-neutral-100 my-3 border-2 border-neutral-700 p-2 rounded-4xl flex justify-between md:grid md:grid-cols-5 sticky top-2 z-1">
